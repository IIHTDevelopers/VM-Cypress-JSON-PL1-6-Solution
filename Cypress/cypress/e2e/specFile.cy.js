...
describe('Automation Suite for Yaksha Application', () => {
  ...
  it('Test Case-1: Verify "Delete Post" Functionality', () => {
    ...
    // Logging
    cy.log('Buzz Post Deletion functionality verified successfully');
  });
  ...
  it('Test Case-2: Verify "Get" help button is functional', () => {
    ...
    // Logging
    cy.log('"Get" help button functionality verified successfully');
  });
  ...
  it('Test Case-3: Verify List of Reports ', () => {
    ...
    // Logging  
    cy.log('Verify Employee List Presense Completed Successfully');
  });
  ...
  it('Test Case-5: Verify Primary Colour of corporate branding could be changed', () => {
    ...
    // Logging
    cy.log('Primary Colour changed successfully');
  });
  ...
  it('Test Case-7: Verify Language change Functionality  ', () => {
    ...
    // Logging
    cy.log('Admin Language Change functionality verified successfully');
  });


  // Test Case 8
  it('Test Case-08 : Verify Required Field Error in Leaves Tab displays when required field is empty', () => {
    cy.wrap(null).then(() => {
    ...
    // Logging
    cy.log('Required Field Error in Leaves Tab verified successfully');
  });

  // Test Case 9
  it('Test Case-09: Verify My info Download Functionality ', () => {
    cy.wrap(null).then(() => {
      ...
      cy.log('My Info Download functionality verified successfully');
    });
